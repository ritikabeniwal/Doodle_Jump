...
void sj2_cli__init(void) {
  ...
  sj2_cli_struct = app_cli__initialize(5, sj2_cli__output_function, separator);
  ...
  static app_cli__command_s taskcontrol = {.command_name = "taskcontrol",
                                           .help_message_for_command = "Resume or suspend a task.\n"
                                                                       "taskcontrol <suspend/resume> <task name>",
                                           .app_cli_handler = cli_suspend_resume_task};
